...
A single-number system load indicator for Linux. Run it, get one integer back.

> **0** = near idle &nbsp;|&nbsp; **100** = fully utilized, no bottlenecks &nbsp;|&nbsp; **> 100** = bottlenecks forming
...
The four signals are blended into a 0–100 base score:
...
is actively building up queues — response times will be degrading.
...
All dependencies are part of the Linux base system. No packages to install.
